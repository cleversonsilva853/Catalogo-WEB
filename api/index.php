...
// Headers CORS mais flexíveis para debug e mobile
$origin = $_SERVER['HTTP_ORIGIN'] ?? '';
$allowedOrigins = [
    'https://deliverygrill.infornexa.com.br',
    'http://deliverygrill.infornexa.com.br',
    'https://api.deliverygrill.infornexa.com.br',
    'http://localhost:5173',
    'http://localhost'
];
